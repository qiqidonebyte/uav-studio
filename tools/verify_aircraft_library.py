...
check("delete route", '"/api/aircraft/{aircraft_id}"' in main and "response_class=Response" in main)
...
check("top navigation portfolio", 'to="/aircraft"' in app and "design-switcher" in app and "我的飞机" in app)
