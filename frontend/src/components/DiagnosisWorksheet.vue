...
<style scoped>
.diagnosis-worksheet{margin:0 0 14px;padding:14px;border:1px solid rgba(92,174,231,.34);border-radius:10px;background:linear-gradient(145deg,rgba(15,42,66,.96),rgba(10,29,47,.98));color:#dcecf9;box-shadow:0 14px 34px rgba(0,0,0,.14)}header{display:flex;justify-content:space-between;gap:12px;align-items:start}header span{font-size:9px;letter-spacing:.13em;color:#63cfff;font-weight:850}header h3{margin:3px 0;font-size:14px}header p{margin:0;color:#a7bfd2;font-size:10px}header strong{display:grid;place-items:center;width:38px;height:38px;border-radius:50%;border:2px solid #476b89;color:#a8bfd2;font-size:12px}header strong.complete{border-color:#3bc885;color:#6ce3aa}.worksheet-progress{height:4px;margin:11px 0 12px;overflow:hidden;border-radius:4px;background:#18354e}.worksheet-progress i{display:block;height:100%;border-radius:4px;background:linear-gradient(90deg,#2f91dd,#38d39a);transition:width .2s}label{display:grid;grid-template-columns:minmax(135px,.42fr) 1fr;gap:10px;align-items:start;padding:8px 0;border-top:1px solid rgba(115,155,188,.13)}label>span{display:grid;gap:3px}label b{font-size:11px}label small{color:#91aec5;font-size:9px;line-height:1.45}textarea{box-sizing:border-box;width:100%;resize:vertical;border:1px solid #365d79;border-radius:7px;background:#071827;color:#dcecf9;padding:8px;font:inherit;font-size:11px;line-height:1.5;outline:0}textarea:focus{border-color:#37a9ee;box-shadow:0 0 0 2px rgba(55,169,238,.1)}.worksheet-footer{display:flex;align-items:center;justify-content:space-between;gap:10px;margin-top:10px;padding-top:10px;border-top:1px solid rgba(115,155,188,.16)}.worksheet-footer>div{display:grid;gap:2px}.worksheet-footer b{font-size:10px}.worksheet-footer small{color:#9bb4c8;font-size:9px}.worksheet-footer button{border:1px solid #2e8bd0;border-radius:7px;background:#1978bd;color:#fff;padding:8px 10px;font-size:10px;font-weight:800;cursor:pointer}.worksheet-footer button:disabled{opacity:.5}@media(max-width:760px){label{grid-template-columns:1fr}}
</style>
